    ...
    def PRCA(self,
        ...
        for it in range(iter_max):
            ...
            if self.is_adaptive:                
                ...
                self.dalpha = self.rho * (nr_rank / self.nr_total_rank - self.rate_rank) * tanh_ramp(epoch=self.nr_epoch, a=self.rate_decay/50.0, b=self.rate_decay)  # current rangk - target rank
